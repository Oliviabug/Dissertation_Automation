...
#Enter Quandl financial API and be able to fetch the data we want
def Quandl_Request(database_code, dataset_code):

    #Quandl API three parameters we need
    start_date = get_date.get_date_time(-2)
    end_date = get_date.get_date_time(-2)
    APIKEY = 'vn_2yd821asQwLbGhNVZ'
